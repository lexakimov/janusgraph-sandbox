...
import com.example.ferma.annotated.domain.vertex.TeamLead;
import com.example.ferma.annotated.domain.vertex.Tester;
...
//		Graph graph = TinkerGraph.open();
		...
		/*
		output is like:
		{id=4168, label=team_lead, ferma_type=com.example.ferma.annotated.domain.vertex.TeamLead, name=Bob, age=29}
		{id=4304, label=person, ferma_type=com.example.ferma.annotated.domain.vertex.Person, name=Robert, age=71}
		{id=4152, label=programmer, ferma_type=com.example.ferma.annotated.domain.vertex.Programmer, name=Alice, age=26}
		{id=4248, label=tester, ferma_type=com.example.ferma.annotated.domain.vertex.Tester, name=John, age=31}
		{id=4216, label=person, ferma_type=com.example.ferma.annotated.domain.vertex.Person, name=Maggie, age=25}
		 */
