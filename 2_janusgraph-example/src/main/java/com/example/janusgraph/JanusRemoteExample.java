...
public class JanusRemoteExample {
	...
	public static void main(String[] args) throws Exception {
		String config = "2_janusgraph-example/src/main/java/com/example/janusgraph/remote-graph.properties";
...
//		GraphTraversalSource g = AnonymousTraversalSource.traversal().withRemote(remoteConnection);
		...
		GraphTraversalSource g = AnonymousTraversalSource.traversal().withRemote(config);
